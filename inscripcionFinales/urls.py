...
#     path('acta_volante/<int:final_id>/', login_required(acta_volante), name='acta_volante'),
    ...
    path('api/finales_inscriptos_adm/', login_required(api_finales_inscriptos_adm), name='api_finales_inscriptos_adm'),
    ...
    path('api/inscripciones/', login_required(api_lista_inscripciones), name='api_lista_inscripciones'),
    ...
    path('api/mesas/', login_required(api_lista_mesas), name='api_lista_mesas'),
